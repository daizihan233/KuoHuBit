...
async def saucenao(
        app: Ariadne, group: Group, message: MessageChain, event: GroupMessage
):
    ...
    if not image_results:
        await app.send_group_message(
            group, MessageChain(Plain("没搜到！qwq")), quote=event.source
        )
        return
    ...
    msg = MessageChain(Forward(fwd_node_list))
